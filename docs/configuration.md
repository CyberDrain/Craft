...
4. User's UPN is checked against the `allowedUsers` Azure Table for role mapping
...
Roles are cached in-memory for 5 minutes. If a user is not in the table, they are denied access (401).

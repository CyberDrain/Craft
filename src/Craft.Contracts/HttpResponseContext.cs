...
/// Craft.Contracts.dll. It deliberately lives in the <c>Microsoft.Azure.Functions.PowerShellWorker</c>
...
/// so the namespace-qualified name has to match. <c>Craft.PowerShellHost.PowerShellWorker.Initialize</c> derives a

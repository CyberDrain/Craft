...
/// publishes job lifecycle events through <c>Craft.Services.RealtimeBridge</c>; browsers consume them. In-memory,
...
public class RealtimeSettings
{
    ...
    /// off, <c>/.craft/events</c> is not mapped and <c>Craft.Services.RealtimeBridge</c> publishes are no-ops.
    /// </summary>

...
/// process (combined role). See docs/configuration.md#realtime-sse.
///
...
public sealed class RealtimeService : IDisposable
{
    ...
    /// PowerShell PSObject/Hashtable payloads should be normalised by <see cref="RealtimeBridge"/>
    /// before calling; this method only reshapes CLR dictionaries/enumerables for STJ.
    /// </summary>
    ...
    /// <summary>Convert CLR dictionaries/enumerables/primitives into STJ-serializable shapes.</summary>
